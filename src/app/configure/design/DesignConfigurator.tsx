    ...
    return (<div className="relative mt-20 grid grid-cols-3 mb-20 pb-20">
        <div className="relative h-[37.5rem] overflow-hidden col-span-2 w-full 
            ...
            <div className="relative w-60 bg-opacity-50 pointer-events-none aspect-[896/1831] ">
                <AspectRatio ratio={896 / 1831} className="pointer-events-none relative z-50
                ...
                <div className={
                    cn('absolute inset-0 left-[3px] top-px right-[3px] bottom-px rounded-[32px]',
                        `bg-${options.color.tw}`
                    )} />
            </div>
        ...
        <div className="h-[37.5 rem] flex flex-col bg-white">
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <Button
                                        ...
                                        w-4 shrink-0 opacity-50" />
                                    </Button>
                                </DropdownMenuTrigger>
                                <DropdownMenuContent>
                                    {MODELS.options.map((model) => (
                                        <DropdownMenuItem key={model.label}
                                            className={cn("flex text-s, gap-1 items-center p-1.5 cursor-default hover:bg-zinc-100",
                                                {
                                                    ...
                                                    <span className="flex flex-col text-sm">
                                                        ...
                                                        {option.description ? (
                                                            <RadioGroup.Description as='span'
                                                                ...
                                                                <span className="black sm:inline">
                                                                    {option.description}
                                                                </span>
