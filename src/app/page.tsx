        ...
        sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52'>
          <div className='col-span-2 px-6 lg:px-0 lg:pt-4'>
            ...
            flex flex-col items-center lg:items-start'>
              ...
              flex-col item-center sm:items-start">
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            ...
            text-balance !leading-tight font-bold ttext-5xl md:text-6xl
            text-gray-900">
              What our{' '}<span className="relative px-2">customers{' '} <Icons.underline className="hidden
              sm:block pointer-events-none absolute inset-x-0 -bottom-6
              text-green-500"/> </span> say
            </h2>
          ...
          lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  "The case feels durable and I even got a compliement on the design. Had
                  the case for two and a half months now and <span className="p-0.5 bg-slate-800 text-white">the image is super clear</span>,
                  on the case I had before, the image started fading into yellow-ish color after a couple
                  weeks. Love it."
                </p>
              </div>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  heavy scratchmarks on all my last phone cases. This one besides a barely noticeable
                  scratches on the corner
                  <span className="p-0.5 bg-slate-800 text-white">looks brand new after about a year an a half</span>,
                  . I dig it. "
                </p>
              </div>
              <div className="flex gap-4 mt-2">
        ...
        <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            ...
            grid-cols-2 gap-40">
              ...
              md:justify-self-end mx-w-sm rounded-xl bg-gray-900/5 ring-inset
              ring-gray-900/10 lg:rounded-2xl">
                <img src="/horse.jpg" className="rounded-md obbject-cover
          ...
          <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 
          w-fit">
            <li className="w-fit">
